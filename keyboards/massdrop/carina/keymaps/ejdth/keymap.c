...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        LT(1,KC_RALT),KC_A,KC_S,   KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  \
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                   KC_RSFT, \
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_LEFT, LT(1,KC_DOWN), LT(2,KC_UP),KC_RGHT  \
    ),
    [1] = LAYOUT(
    ...
    [2] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_MUTE, KC_VOLD, KC_VOLU, L_PTP,   L_PTN,   L_T_ONF, KC_F11,  KC_F12,  KC_DEL,  \
